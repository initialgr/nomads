    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tbody>
          <tr>
            <td
              style="border-bottom:2px dashed #eee;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0px;text-align:center;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:180px;">
                                <img alt="" src="{{ url('frontend/images/logo@2x.png') }}"
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" src="{{ url($data->travel_package->galleries[0]->image) }}"
                                  style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tbody>
          <tr>
            <td
              style="border-bottom:2px dashed #eee;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:30px;text-align:center;">
                    ...
                    <tr>
                      <td align="left"
                        ...
                        <div
                          ...
                          Hi, {{ $data->user->name }} <br><br> Tiket digital kamu sudah berhasil dicetak. <br> Booking
                          ID
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                          ...
                          <tr>
                            ...
                            <td style="text-align: right;">{{ $data->travel_package->title }},
                              {{ $data->travel_package->location }}</td>
                          </tr>
                          <tr>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                          ...
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#ff9353" role="presentation"
                                style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#ff9353;"
                                valign="middle">
                                <a href="{{ url('checkout/' . $data->id) }}"
                                  style="display:inline-block;background:#ff9353;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                  Check Detail </a>
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                          ...
                          <tr>
                            <td style="width: 50px" ;>
                              <img src="{{ url('frontend/images/ic_support-2.png') }}" width="50px">
                            </td>
                            <td
                              style="font-size:18px; padding-left:10px; color:#071c4d; Assistant, Helvetica, Arial, sans-serif">
